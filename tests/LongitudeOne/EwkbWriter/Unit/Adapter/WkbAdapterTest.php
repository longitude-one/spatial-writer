...
use LongitudeOne\EwkbWriter\Exception\UnsupportedSpatialInterface;
use LongitudeOne\EwkbWriter\Exception\UnsupportedSpatialType;
...
class WkbAdapterTest extends TestCase
{
     ...
     *
     * @return \Generator<string, array{0: LineStringInterface, 1: string}, void, null>
     *
     ...
     *
     * @return \Generator<string, array{0: MultiLineStringInterface, 1: string}, void, null>
     *
     ...
     *
     * @return \Generator<string, array{0: MultiPolygonInterface, 1: string}, void, null>
     *
     ...
     *
     * @return \Generator<string, array{0: MultiPointInterface, 1: string}, void, null>
     *
     ...
     *
     * @return \Generator<string, array{0: PointInterface, 1: string}, void, null>
     *
     ...
     *
     * @return \Generator<string, array{0: PolygonInterface, 1: string}, void, null>
     *
     ...
     *
     * @throws UnsupportedSpatialInterface Data provider only provides valid line-strings
     * @throws UnsupportedSpatialType      Data provider only provides valid line-strings
     */
     ...
     * @param string                   $expected        expected result in hexadecimal format
     *
     * @throws UnsupportedSpatialInterface Data provider only provides valid multi-line-strings
     * @throws UnsupportedSpatialType      Data provider only provides valid multi-line-strings
     */
     ...
     * @param string              $expected   expected result in hexadecimal format
     *
     * @throws UnsupportedSpatialInterface Data provider only provides valid multi-points
     * @throws UnsupportedSpatialType      Data provider only provides valid multi-points
     */
     ...
     * @param string                $expected     expected result in hexadecimal format
     *
     * @throws UnsupportedSpatialInterface Data provider only provides valid multi-polygons
     * @throws UnsupportedSpatialType      Data provider only provides valid multi-polygons
     */
     ...
     * @param string         $expected expected result in hexadecimal format
     *
     * @throws UnsupportedSpatialInterface Data provider only provides valid points
     * @throws UnsupportedSpatialType      Data provider only provides valid points
     */
     ...
     * @param string           $expected expected result in hexadecimal format
     *
     * @throws UnsupportedSpatialInterface Data provider only provides valid polygons
     * @throws UnsupportedSpatialType      Data provider only provides valid polygons
     */
