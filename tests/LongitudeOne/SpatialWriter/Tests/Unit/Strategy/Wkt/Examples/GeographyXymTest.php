...
use LongitudeOne\SpatialTypes\Types\Dimension3m\Geography\LineString;
use LongitudeOne\SpatialTypes\Types\Dimension3m\Geography\MultiLineString;
use LongitudeOne\SpatialTypes\Types\Dimension3m\Geography\MultiPoint;
use LongitudeOne\SpatialTypes\Types\Dimension3m\Geography\MultiPolygon;
use LongitudeOne\SpatialTypes\Types\Dimension3m\Geography\Point;
use LongitudeOne\SpatialTypes\Types\Dimension3m\Geography\Polygon;
use LongitudeOne\SpatialTypes\Types\Dimension3m\Geography\Triangle;
...
/**
 * Explicit WKT examples for Geography objects with a measure ordinate (XYM).
 *
 * @internal
 */
#[CoversClass(WktTextStrategy::class)]
#[CoversClass(WktTypeEncoder::class)]
class GeographyXymTest extends TestCase
{
    ...
    public function testGeographyCollectionEmpty(): void
    {
        ...
        static::assertSame('GEOMETRYCOLLECTION M EMPTY', (new WktTextStrategy())->executeStrategy($collection));
    }
    ...
    public function testLineString(): void
    {
        ...
        static::assertSame('LINESTRING M (0 0 10, 2 3 20, 4 1 30)', (new WktTextStrategy())->executeStrategy($line));
    }
    ...
    public function testLineStringEmpty(): void
    {
        ...
        static::assertSame('LINESTRING M EMPTY', (new WktTextStrategy())->executeStrategy($line));
    }
    ...
    public function testMultiLineString(): void
    {
        ...
        static::assertSame('MULTILINESTRING M ((0 0 10, 2 3 20), (4 1 30, 5 2 40))', (new WktTextStrategy())->executeStrategy($lines));
    }
    ...
    public function testMultiLineStringEmpty(): void
    {
        ...
        static::assertSame('MULTILINESTRING M EMPTY', (new WktTextStrategy())->executeStrategy($lines));
    }
    ...
    public function testMultiPoint(): void
    {
        ...
        static::assertSame('MULTIPOINT M ((1 2 10), (3 4 20))', (new WktTextStrategy())->executeStrategy($points));
    }
    ...
    public function testMultiPointEmpty(): void
    {
        ...
        static::assertSame('MULTIPOINT M EMPTY', (new WktTextStrategy())->executeStrategy($points));
    }
    ...
    public function testMultiPolygonEmpty(): void
    {
        ...
        static::assertSame('MULTIPOLYGON M EMPTY', (new WktTextStrategy())->executeStrategy($polygons));
    }
    ...
    public function testPoint(): void
    {
        ...
        static::assertSame('POINT M (2.5 -3 10)', (new WktTextStrategy())->executeStrategy($point));
    }
    ...
    public function testPointEmpty(): void
    {
        ...
        static::assertSame('POINT M EMPTY', (new WktTextStrategy())->executeStrategy($point));
    }
    ...
    public function testPolygonEmpty(): void
    {
        ...
        static::assertSame('POLYGON M EMPTY', (new WktTextStrategy())->executeStrategy($polygon));
    }
    ...
    public function testTriangle(): void
    {
        ...
        static::assertSame('TRIANGLE M ((0 0 10, 2 0 10, 0 2 10, 0 0 10))', (new WktTextStrategy())->executeStrategy($triangle));
    }
    ...
    public function testTriangleEmpty(): void
    {
        ...
        static::assertSame('TRIANGLE M EMPTY', (new WktTextStrategy())->executeStrategy($triangle));
    }
}
