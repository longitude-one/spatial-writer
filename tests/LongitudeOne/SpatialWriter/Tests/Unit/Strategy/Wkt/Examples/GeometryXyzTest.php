...
/**
 * Explicit WKT examples for Geometry objects with elevation (XYZ).
 *
 * @internal
 */
...
class GeometryXyzTest extends TestCase
{
    ...
    public function testGeometryCollectionEmpty(): void
    {
        ...
        static::assertSame('GEOMETRYCOLLECTION Z EMPTY', (new WktTextStrategy())->executeStrategy($collection));
    }
    ...
    public function testLineString(): void
    {
        ...
        static::assertSame('LINESTRING Z (0 0 5, 2 3 6, 4 1 7)', (new WktTextStrategy())->executeStrategy($line));
    }
    ...
    public function testLineStringEmpty(): void
    {
        ...
        static::assertSame('LINESTRING Z EMPTY', (new WktTextStrategy())->executeStrategy($line));
    }
    ...
    public function testMultiLineString(): void
    {
        ...
        static::assertSame('MULTILINESTRING Z ((0 0 5, 2 3 6), (4 1 7, 5 2 8))', (new WktTextStrategy())->executeStrategy($lines));
    }
    ...
    public function testMultiLineStringEmpty(): void
    {
        ...
        static::assertSame('MULTILINESTRING Z EMPTY', (new WktTextStrategy())->executeStrategy($lines));
    }
    ...
    public function testMultiPoint(): void
    {
        ...
        static::assertSame('MULTIPOINT Z ((1 2 5), (3 4 6))', (new WktTextStrategy())->executeStrategy($points));
    }
    ...
    public function testMultiPointEmpty(): void
    {
        ...
        static::assertSame('MULTIPOINT Z EMPTY', (new WktTextStrategy())->executeStrategy($points));
    }
    ...
    public function testMultiPolygonEmpty(): void
    {
        ...
        static::assertSame('MULTIPOLYGON Z EMPTY', (new WktTextStrategy())->executeStrategy($polygons));
    }
    ...
    public function testPoint(): void
    {
        ...
        static::assertSame('POINT Z (2.5 -3 5)', (new WktTextStrategy())->executeStrategy($point));
    }
    ...
    public function testPointEmpty(): void
    {
        ...
        static::assertSame('POINT Z EMPTY', (new WktTextStrategy())->executeStrategy($point));
    }
    ...
    public function testPolygonEmpty(): void
    {
        ...
        static::assertSame('POLYGON Z EMPTY', (new WktTextStrategy())->executeStrategy($polygon));
    }
    ...
    public function testPolyhedralSurfaceEmpty(): void
    {
        ...
        static::assertSame('POLYHEDRALSURFACE Z EMPTY', (new WktTextStrategy())->executeStrategy($surface));
    }
    ...
    public function testTriangle(): void
    {
        ...
        static::assertSame('TRIANGLE Z ((0 0 5, 2 0 5, 0 2 5, 0 0 5))', (new WktTextStrategy())->executeStrategy($triangle));
    }
    ...
    public function testTriangleEmpty(): void
    {
        ...
        static::assertSame('TRIANGLE Z EMPTY', (new WktTextStrategy())->executeStrategy($triangle));
    }
}
