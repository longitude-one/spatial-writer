 ...
 * @internal
 *
 * @covers \LongitudeOne\SpatialWriter\Strategy\WktTextStrategy
 */
class WktStrategyTest extends TestCase
{
    ...
    {
        static::assertSame($expected, (new WktTextStrategy())->executeStrategy($spatial));
    }
    ...
    public function testNonFiniteCoordinate(float $coordinate): void
    {
        ...
        (new WktTextStrategy())->executeStrategy(new Point($coordinate, 0));
    }
    ...
    public function testNumericLocale(): void
    {
        ...
        try {
            static::assertSame('POINT (42.42 -2.5)', (new WktTextStrategy())->executeStrategy(new Point(42.42, -2.5)));
        } finally {
    ...
    public function testUnsupportedInterface(): void
    {
        ...
        (new WktTextStrategy())->executeStrategy($spatial);
    }
