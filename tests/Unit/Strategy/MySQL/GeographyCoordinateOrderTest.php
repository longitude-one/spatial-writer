...
/**
 * MySQL longitude-first regression examples for two-dimensional Geography objects.
 *
 * @internal
 */
#[CoversClass(MySQLBinaryStrategy::class)]
class GeographyCoordinateOrderTest extends TestCase
{
    ...
    public function testGeographyCollection(): void
    {
        ...
        static::assertSame(
            ...
            bin2hex((new MySQLBinaryStrategy())->encode($collection))
        );
    }
    ...
    public function testLineString(): void
    {
        ...
        static::assertSame(
            ...
            bin2hex((new MySQLBinaryStrategy())->encode($line))
        );
    }
    ...
    public function testMultiLineString(): void
    {
        ...
        static::assertSame(
            ...
            bin2hex((new MySQLBinaryStrategy())->encode($lines))
        );
    }
    ...
    public function testMultiPoint(): void
    {
        ...
        static::assertSame(
            ...
            bin2hex((new MySQLBinaryStrategy())->encode($points))
        );
    }
    ...
    public function testMultiPolygon(): void
    {
        ...
        static::assertSame(
            ...
            bin2hex((new MySQLBinaryStrategy())->encode($polygons))
        );
    }
    ...
    public function testNestedCollection(): void
    {
        $collection = new GeographyCollection(4326, [
            ...
            new GeographyCollection(4326, [new GeographyCollection(4326, [])]),
        ]);
        static::assertSame(
    ...
    public function testParisPoint(): void
    {
        ...
        static::assertSame(
            ...
            bin2hex((new MySQLBinaryStrategy())->encode($point))
        );
    }
    ...
    public function testPolygon(): void
    {
        ...
        static::assertSame(
            ...
            bin2hex((new MySQLBinaryStrategy())->encode($polygon))
        );
    }
}
