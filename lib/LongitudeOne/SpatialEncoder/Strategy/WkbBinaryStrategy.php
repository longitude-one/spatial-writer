...
class WkbBinaryStrategy implements StrategyInterface
{
     ...
     *
     * @param SpatialInterface $spatial the spatial interface to encode into ISO WKB format
     *
